...
camera.position.set(0, 1.5,1 ); // First-person camera at height 1.6
...
function light3() {
  ...
  function loadModel() {
    ...
    loader.load(
        ...
        // Progress callback
        // (xhr) => {
        //     const total = xhr.total || 1; // Prevent division by zero if total is 0
        //     const progress = Math.min((xhr.loaded / total) * 100, 100);
